...
echo "******************************************************************"
echo " Fractals 2019"
echo " (C) 2018-2019 Mikhail Prokopenko, Peter Wang                     "
echo " "
echo " Based on Gliders2d base"
echo " (C) 2018-2019 Mikhail Prokopenko, Peter Wang                     "
echo " "
echo " Based on HELIOS base"
...
team_graphic="--use_team_graphic on --team_graphic_file ${DIR}/fractals.xpm"
...
usage()
{
  (echo "Usage: $0 [options]"
   ...
   echo "  --library-base DIR           specifies the base path to librcsc (default: '')"
   echo "  --library-ext DIRNAME        directory name for librcsc added to the base name (default: '')" 
...
if test -n "$libbase$libext"; then
  LIBPATH="$libbase/$libext/lib"
