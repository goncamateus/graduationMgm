...
setup(name = 'hfo',
      version='0.2.1',
      author='Mateus Goncalves, Matthew Hausknecht',
      author_email='mgm4@cin.ufpe.br, matthew.hausknecht@gmail.com',
      description='Field Offense in 2D RoboCup Soccer. Based on Hausknecht HFO',
      license='MIT',
      ext_modules = [module1],
      keywords=('Robocup '
                'Field-offense '
